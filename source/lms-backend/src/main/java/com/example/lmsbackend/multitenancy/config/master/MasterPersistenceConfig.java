package com.example.lmsbackend.multitenancy.config.master;
...
@Configuration
@PropertySource(value = "classpath:multitenant.properties")
@EnableJpaRepositories(
        basePackages = {"com.example.lmsbackend.multitenancy.repository"},
