...
public class UnitClassRule implements Rule {
    ...
    public ResourceType getResourceType() {
        return ResourceType.UNIT_CLASS;
    }

    @Override
    public boolean authorize(CustomUserDetails currUser, PermissionSecurity permission, long resourceId) {
        var classId = chapterActivityClassRepository.findClassIdByActivity(resourceId, ActionType.UNIT.name());
