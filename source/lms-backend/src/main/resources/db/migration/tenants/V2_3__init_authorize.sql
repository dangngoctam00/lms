INSERT INTO user_has_permission (user_id, permission_id, is_limit_by_branch, is_limit_by_teaching, is_limit_by_dean,
                                 is_limit_by_manager, is_limit_by_learn, valid_from, expires_at)
values (3, 1, 1, -1, 0, 1, -1, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_permission (user_id, permission_id, is_limit_by_branch, is_limit_by_teaching, is_limit_by_dean,
                                 is_limit_by_manager, is_limit_by_learn, valid_from, expires_at)
values (3, 2, 1, 1, -1, 0, -1, '2020-03-10 12:00:00', '2025-08-10 12:00:00');


INSERT INTO user_has_permission (user_id, permission_id, is_limit_by_branch, is_limit_by_teaching, is_limit_by_dean,
                                 is_limit_by_manager, is_limit_by_learn, valid_from, expires_at)
values (1, 1, 1, -1, 0, 1, 1, '2022-03-10 12:00:00', '2022-08-10 12:00:00');



INSERT INTO role (id, description, title)
VALUES (default, 'Đây là admin', 'Admin');
INSERT INTO role (id, description, title)
VALUES (default, 'Đây là employee', 'Nhân viên');
INSERT INTO role (id, description, title)
VALUES (default, 'Học sinh', 'Học sinh');
INSERT INTO role (id, description, title)
VALUES (default, 'Giáo viên', 'Giáo viên');
...
-- ADMIN ROLE and EMPLOYEE ROLE for users: lmslms1, lmslms16, lmslms17

INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (1, 1, '2022-03-10 12:00:00', '2022-08-10 12:00:00');

INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (1, 2, '2022-03-10 12:00:00', '2022-08-10 12:00:00');

INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (16, 1, '2022-03-10 12:00:00', '2022-08-10 12:00:00');

INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (17, 1, '2022-03-10 12:00:00', '2022-08-10 12:00:00');


-- TEACHER ROLE for users: lmslms2 -> lmslms4

INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (2, 4, '2022-03-10 12:00:00', '2022-08-10 12:00:00');

INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (3, 4, '2022-03-10 12:00:00', '2022-08-10 12:00:00');

INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (4, 4, '2022-03-10 12:00:00', '2022-08-10 12:00:00');

-- STUDENT ROLE for users: lmslms5 -> lmslms15
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (5, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (6, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (7, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (8, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (9, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (10, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (11, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (12, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (13, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (14, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');
INSERT INTO user_has_role (user_id, role_id, valid_from, expires_at)
VALUES (15, 3, '2022-03-10 12:00:00', '2022-08-10 12:00:00');