...
func (c *Client) Use(hooks ...Hook) {
	c.Exam.Use(hooks...)
	c.ExamHistory.Use(hooks...)
	c.Question.Use(hooks...)
	c.QuestionHistory.Use(hooks...)
}
...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.ExamHistory.Intercept(interceptors...)
	c.Question.Intercept(interceptors...)
	c.QuestionHistory.Intercept(interceptors...)
}
...
type (
	hooks struct {
		Exam, ExamHistory, Question, QuestionHistory []ent.Hook
	}
	inters struct {
		Exam, ExamHistory, Question, QuestionHistory []ent.Interceptor
	}
)
